...
<link rel="stylesheet" href="/css/login/camera.css" media="all">
...
<body>
			...
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="form-actions">
					<div style="width: 86%; padding-left: 8%;">
						...
						<div style="float: left;">
							<i><img src="/imgs/login/yan.png" /></i>
						</div>
	...
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			<div data-src="/imgs/login/banner_slide_01.jpg"></div>
			<div data-src="/imgs/login/banner_slide_02.jpg"></div>
			<div data-src="/imgs/login/banner_slide_03.jpg"></div>
		</div>
		<!-- #camera_wrap_3 -->
	...
	<script src="/js/login/jquery.easing.1.3.js"></script>
	<script src="/js/login/jquery.mobile.customized.min.js"></script>
	<script src="/js/login/templatemo_script.js"></script>
	<script type="text/javascript" src="/js/jquery.tips.js"></script>
	<script type="text/javascript" src="/js/jquery.cookie.js"></script>
	<script src="/js/login/camera.min.js"></script>
